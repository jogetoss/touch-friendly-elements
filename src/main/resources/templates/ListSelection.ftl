<div class="form-cell" ${elementMetaData!}>
    ...
    <#if !(request.getAttribute("org.joget.ListSelectionElement")??) >
    <style>
        .listSelection{
            outline: 0px;
            width:100% !important;
        ...
        body .listSelection > input[type="checkbox"]:not(:checked),
        body .listSelection > input[type="checkbox"]:checked,
